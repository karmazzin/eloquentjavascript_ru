...
В переменной <a href="http://eloquentjavascript.net/code/game_levels.js">GAME_LEVELS</a> хранится набор планов уровней. Такая страница скармливает их в runGame, которая запускает саму игру.
